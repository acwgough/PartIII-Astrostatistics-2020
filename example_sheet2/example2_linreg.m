...
% Note that mle_regress_xy_gx1 implements a more general model than
% required for this problem.  Your code may be simpler.
...
% In principle, you could minimise just L1(alpha, beta, sigma)

% or, in practice, you could use same likelihood code as before, but fixing
% tau = 1e3 very large
